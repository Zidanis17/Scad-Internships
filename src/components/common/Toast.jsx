 ...
 * @param {string} props.type - Type of toast: 'success', 'error', 'warning', or 'info'
...
const Toast = ({ 
  ...
  return (
    <div className={`fixed top-4 right-4 z-50 p-4 rounded border-l-4 shadow-md ${getToastStyles()}`}>
